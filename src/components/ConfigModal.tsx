...
export const ConfigModal: React.FC<ConfigModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-2xl max-w-2xl w-full p-5 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900">Agent Voice & Telephony Settings</h2>
        ...
        <div className="space-y-4 text-xs">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              ...
              >
                <span className="font-bold text-slate-900 block">{prov.title}</span>
                <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{prov.desc}</span>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <div>
              <label className="block text-slate-700 font-bold mb-1">Prebuilt Voice Persona</label>
              <select
            ...
            <div>
              <label className="block text-slate-700 font-bold mb-1">Speaking Rate ({formData.speakingRate}x)</label>
              <input
                type="range"
                min="0.8"
                max="1.2"
          ...
          <div className="p-3.5 rounded-xl bg-indigo-50/80 border border-indigo-200 space-y-2.5">
            <div className="flex items-center justify-between">
              <span className="font-bold text-indigo-900 flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-amber-500" /> Auto-Generate High-Converting Prompt
              </span>
              <span className="text-[10px] text-indigo-700 font-mono font-bold">Gemini 3.6 Flash</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="bg-white border border-slate-300 rounded-lg p-2 text-slate-900 font-medium"
              />
              <select
                value={toneInput}
            ...
            <button
              ...
              className="w-full py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold flex items-center justify-center gap-2 transition-all shadow-xs"
            >
              {isGeneratingScript ? (
          ...
          <div>
            <label className="block text-slate-700 font-bold mb-1">System Instructions & Behavior Rules</label>
            <textarea
              rows={5}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-slate-700 font-bold mb-1">CRM Webhook URL (Podio/GoHighLevel)</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-slate-700 font-bold mb-1">Auto-Calendar Booking Link</label>
              <input
                type="text"
        ...
        <div className="flex justify-end gap-2 pt-3 border-t border-slate-200">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium">
            Cancel
          </button>
          <button
            onClick={() => {
            ...
            className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-bold flex items-center gap-1.5 shadow-xs"
          >
